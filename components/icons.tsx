...
export const SpeakerIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const BotIcon: React.FC<IconProps> = ({ className = 'w-8 h-8' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
        <path d="M12 2C6.486 2 2 6.486 2 12v2.242c0 1.253.388 2.454 1.108 3.447l.025.034a8.02 8.02 0 0 0 1.732 1.943 10.001 10.001 0 0 0 14.27 0 8.02 8.02 0 0 0 1.732-1.943l.025-.034C21.612 16.696 22 15.495 22 14.242V12c0-5.514-4.486-10-10-10zm0 18c-4.411 0-8-3.589-8-8s3.589-8 8-8 8 3.589 8 8-3.589 8-8 8z"></path><path d="M12 8a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5zm0 4a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3z"></path><path d="M8.992 14.11a1 1 0 0 0-1.414 1.414 4.004 4.004 0 0 0 5.656 0 1 1 0 1 0-1.414-1.414 2.002 2.002 0 0 1-2.828 0z"></path>
    </svg>
);
...
export const SitemapIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const CardStackIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.429 9.75L2.25 12l4.179 2.25m0-4.5l5.571 3 5.571-3m-11.142 0L2.25 12l4.179 2.25M6.429 15.75l5.571 3 5.571-3M6.429 15.75l-4.179-2.25M21.75 12l-4.179-2.25m4.179 2.25l-4.179 2.25m0 0l-5.571 3-5.571-3" />
    </svg>
);
...
export const ChildIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
        <path d="M12 2C9.243 2 7 4.243 7 7s2.243 5 5 5 5-2.243 5-5S14.757 2 12 2zm0 8c-1.654 0-3-1.346-3-3s1.346-3 3-3 3 1.346 3 3-1.346 3-3 3z"></path><path d="M12 14c-3.309 0-6 2.691-6 6v2h12v-2c0-3.309-2.691-6-6-6zm-4 6v-2c0-2.206 1.794-4 4-4s4 1.794 4 4v2H8z"></path>
    </svg>
);
...
export const UsersIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962a3.75 3.75 0 100-7.5 3.75 3.75 0 000 7.5zM3 13.255v1.5a5.25 5.25 0 005.25 5.25h3a5.25 5.25 0 005.25-5.25v-1.5m-10.5-6.362a3.75 3.75 0 100 7.5 3.75 3.75 0 000-7.5zM6.75 6.75h.75v.75h-.75v-.75zM6 15.75v.007v.007v-.007zM9 15.75v.007v.007v-.007z" />
    </svg>
);
...
export const LogoutIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0013.5 3h-6a2.25 2.25 0 00-2.25 2.25v13.5A2.25 2.25 0 007.5 21h6a2.25 2.25 0 002.25-2.25V15m-12-6h12.75" />
    </svg>
);
...
export const WhiteboardIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 18.375V12.75M12 12.75L15.375 9M12 12.75L8.625 9M15.375 9L12 5.625M8.625 9L12 5.625M3 18.375V5.625C3 4.58332 3.83332 3.75 4.875 3.75H19.125C20.1667 3.75 21 4.58332 21 5.625V18.375C21 19.4167 20.1667 20.25 19.125 20.25H4.875C3.83332 20.25 3 19.4167 3 18.375Z" />
    </svg>
);
...
export const EraserIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
      <path d="M19.7,18.3L12.4,11L18,5.4L16.6,4L11,9.6L5.4,4L4,5.4L9.6,11L4,16.6L5.4,18L11,12.4l7.3,7.3L19.7,18.3z M20.4,21.5 L19,20.1l-2.8-2.8l-0.7-0.7l-4.2-4.2l-4.2-4.2L6.4,7.5L3.5,4.6L2.1,6L18.5,22.9L20.4,21.5z" />
    </svg>
);
...
export const BuildingLibraryIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const CalendarDaysIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0h18M7.5 12h.008v.008H7.5V12zm3 0h.008v.008H10.5V12zm3 0h.008v.008H13.5V12zm3 0h.008v.008H16.5V12zM7.5 15h.008v.008H7.5V15zm3 0h.008v.008H10.5V15zm3 0h.008v.008H13.5V15zm3 0h.008v.008H16.5V15z" />
    </svg>
);
...
export const BoldIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path d="M15.6 10.79c.97-.67 1.65-1.77 1.65-2.79 0-2.26-1.75-4-4.25-4H7v14h7.04c2.09 0 3.71-1.7 3.71-3.79 0-1.52-.86-2.82-2.15-3.42zM10 6.5h3c.83 0 1.5.67 1.5 1.5s-.67 1.5-1.5 1.5h-3v-3zm3.5 9H10v-3h3.5c.83 0 1.5.67 1.5 1.5s-.67 1.5-1.5 1.5z"/>
    </svg>
);
...
export const CodeBracketIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M17.25 6.75 19.5 12l-2.25 2.25m-7.5 0L7.5 12l2.25-2.25M6 20.25h12A2.25 2.25 0 0 0 20.25 18V6A2.25 2.25 0 0 0 18 3.75H6A2.25 2.25 0 0 0 3.75 6v12A2.25 2.25 0 0 0 6 20.25Z" />
    </svg>
);

export const BugAntIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M11.373 5.414a.75.75 0 0 1 .75 0l5.25 3a.75.75 0 0 1 0 1.172l-5.25 3a.75.75 0 0 1-.75 0l-5.25-3a.75.75 0 0 1 0-1.172l5.25-3Z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="m15.75 8.25-4.5 2.625-4.5-2.625m4.5 6.375v4.5m-4.5-4.5v4.5m4.5 0h-4.5" />
    </svg>
);

export const LightbulbIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 0 0 1.5-.189m-1.5.189a6.01 6.01 0 0 1-1.5-.189m3.75 7.478a12.06 12.06 0 0 1-4.5 0m3.75 2.311V21m-3.75 0v-.511m0 0a18.06 18.06 0 0 1-9.375-3.164m9.375 3.164a18.06 18.06 0 0 0 9.375-3.164m-16.5 0a18.06 18.06 0 0 1 3.75-3.164m6.75 0a18.06 18.06 0 0 0 3.75-3.164m-16.5 0a18.06 18.06 0 0 0-3.75 3.164m6.75 0a18.06 18.06 0 0 1-3.75 3.164m16.5 0a18.06 18.06 0 0 0-3.75-3.164m-9.375 0a18.06 18.06 0 0 1 3.75 3.164" />
    </svg>
);

export const DocumentMagnifyingGlassIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="m15.75 15.75-2.25-2.25" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 15.75a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0Z" />
    </svg>
);
